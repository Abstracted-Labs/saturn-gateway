      ...
      <div class="absolute z-1">
        <div class="flex items-center justify-center text-center translate-y-[25%] lg:translate-y-[50%]">
          <div class="flex flex-col items-around inset-0 text-center">
            ...
            <p class={`${ !isLightTheme() ? 'text-white' : 'text-black' } text-sm/tight w-1/2 lg:w-2/3 px-10 block text-center mx-auto`}>A multichain multisig secured by Polkadot that can manage assets across any blockchain.</p>
