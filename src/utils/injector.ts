import type { Injected, InjectedExtension, InjectedWindow, InjectOptions } from '@polkadot/extension-inject/types';
import { cyrb53 } from '@polkadot/extension-inject/cyrb53';
...
export function injectExtensionInto (w: Window, enable: (origin: string) => Promise<Injected>, { name, version }: InjectOptions): void {
  // small helper with the typescript types, just cast window
  const windowInject = w as Window & InjectedWindow;
