...
const LeftContent = (props: { inDrawer: boolean; }) => {
  return <div class={`h-[87%] px-5 pt-1 pb-10 lg:pb-2 flex flex-col bg-saturn-offwhite dark:bg-saturn-black ${ props.inDrawer ? 'overflow-y-hidden' : 'mr-4 overflow-y-auto saturn-scrollbar' }`}
  >
