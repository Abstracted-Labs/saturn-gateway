...
const ConnectWallet = () => {
  ...
  return <div class="relative">
    <button
      ...
      class={`${ BUTTON_COMMON_STYLE } text-sm text-saturn-black dark:text-saturn-offwhite h-full justify-between pl-4 z-30 w-60 flex items-center focus:outline-none`}
      type="button">
