...
const DrawerRight = () => {
  return <div id="rightSidebar" class="fixed top-0 right-0 z-[60] w-full md:w-80 h-full overflow-y-scroll transition-transform -translate-x-full bg-saturn-offwhite dark:bg-saturn-black">
