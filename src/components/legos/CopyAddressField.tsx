...
const CopyAddressField = (props: CopyAddressFieldProps) => {
  ...
  return <>
    <div class="rounded-md bg-saturn-offwhite dark:bg-gray-900 text-saturn-darkgrey dark:text-saturn-lightgrey p-2 flex flex-row items-center justify-center text-xs border border-gray-800 hover:opacity-50 hover:cursor-copy" onClick={(e) => openAddressSelectorModal(e)}>
